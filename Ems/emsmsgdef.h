...
typedef enum _EMS_API_NUMBER
{
	...
	EmsMaxApiNumber
} EMS_API_NUMBER, *PEMS_API_NUMBER;
...
typedef enum _EMS_MODULE_SHUTDOWN_REASON
{
	...
	EmsMaxReason
} EMS_MODULE_SHUTDOWN_REASON, *PEMS_MODULE_SHOUTDOWN_REASON; 
...
typedef enum _EMS_MODULE_SUSPEND_TYPE
{
	EmsSuspendTypeUser,
	EmsSuspendTypeHost
} EMS_MODULE_SUSPEND_TYPE, *PEMS_MODULE_SUSPEND_TYPE;
...
} EMS_BUTTON_CREATION_LOCATION, *PEMS_BUTTON_CREATION_LOCATION;
...
} EMS_EXPLORER_SETTING_TYPE, *PEMS_EXPLORER_SETTING_TYPE;
